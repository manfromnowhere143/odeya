...
hardening operation. On 2026-07-19, exact read-back observed disabled pull
requests, the inert merge configuration, full-SHA Action admission, read-only
workflow tokens, and active no-bypass rulesets `19178198` for permanent
