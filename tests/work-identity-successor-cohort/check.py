...
RESOURCE_EXPECTED = [
    {
        ...
        "predecessor_schema_id": "urn:odeya:schema:work-intent:0.5.0",
        "successor_path": "schemas/work-intent-profile-bound-candidate.schema.json",
        "successor_schema_id": "urn:odeya:schema:work-intent:0.12.0",
    ...
    },
    {
        ...
        "predecessor_schema_id": "urn:odeya:schema:canonical-work-lease:0.5.0",
        "successor_path": "schemas/canonical-work-lease-profile-bound-candidate.schema.json",
        "successor_schema_id": "urn:odeya:schema:canonical-work-lease:0.8.0",
    ...
    },
    {
        ...
        "predecessor_schema_id": "urn:odeya:schema:work-contract:0.11.0",
        "successor_path": "schemas/work-contract-profile-bound-candidate.schema.json",
        "successor_schema_id": "urn:odeya:schema:work-contract:0.10.0",
        "candidate_path": "architecture/work-contract-profile-bound-candidate.json",
    },
]
EXPECTED_EDGES = [
    {
        "consumer_schema_id": "urn:odeya:schema:work-intent:0.12.0",
        "dependency_schema_id": "urn:odeya:schema:work-intent-core:0.1.0",
        "binding": "exact_external_ref_and_raw_schema_digest",
    },
    {
        "consumer_schema_id": "urn:odeya:schema:canonical-work-lease:0.8.0",
        "dependency_schema_id": "urn:odeya:schema:work-intent:0.12.0",
        "binding": "exact_successor_schema_and_candidate_raw_bytes",
    },
    {
        "consumer_schema_id": "urn:odeya:schema:work-contract:0.10.0",
        "dependency_schema_id": "urn:odeya:schema:work-intent:0.12.0",
        "binding": "exact_successor_schema_and_candidate_raw_bytes",
    },
]
...
def evaluate(
    ...
    if (
        ...
        != "urn:odeya:schema:work-intent:0.12.0"
