...
EXPECTED_CONSUMERS = [
    {
        ...
        "prospective_schema_id": "urn:odeya:schema:canonical-work-lease:0.6.0",
    },
    {
        "schema_path": "schemas/work-contract.schema.json",
        "current_schema_id": "urn:odeya:schema:work-contract:0.9.0",
        "prospective_schema_id": "urn:odeya:schema:work-contract:0.8.0",
    },
]
