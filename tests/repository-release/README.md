...
candidate creation and resume. The live GitHub verifier self-test rejects ten
check mutations, sixteen governance mutations, six retained-receipt mutations,
six API-identity/query mutations, five disabled-PR-census mutations, six CLI-boundary
mutations, five mutation-journal mutations, and nine final
