...
DEDICATED_ARCHITECTURE_EVIDENCE_COMMANDS = (
    ...
    (
        "prq-002f-numeric-trace-conformance",
        "python scripts/validate_profile_0_3_numeric_trace_conformance.py "
        "--recompute-all "
        '--python-executable "$ODEYA_PRQ002_PYTHON" '
        '--node-executable "$ODEYA_PRQ002_NODE"',
    ),
    (
        "prq-002g-jcs-conformance",
        "python tests/profile-0-3-jcs-conformance/authoring/generate_vectors.py "
        "--check && "
        "python scripts/validate_profile_0_3_jcs_conformance.py "
        "--recompute-all "
        '--python-executable "$ODEYA_PRQ002_PYTHON" '
        '--node-executable "$ODEYA_PRQ002_NODE"',
    ),
...
ARCHITECTURE_EVIDENCE_COUNT_BOUNDARY = (
    ...
    "recomputation, the PRQ-002F numeric-trace conformance recomputation, and "
    "the PRQ-002G JCS serialization conformance recomputation. "
...
EXPECTED_ARCHITECTURE_EVIDENCE_JOB_SHA256 = (
    "45af01550727cde7dc16709c4af826fadd1a60859d0e1ed2e5d3bcaf2a7cec62"
)
EXPECTED_INTEGRATED_VALIDATOR_SHA256 = (
    "1c46d9b3dc665a7c137b744a7840e274bc9293c620f0be219654498d12317541"
)
FOUNDATION_TIMEOUT_MAP_ERROR = (
    "Foundation timeout policy must retain the exact 30-second default and "
    "path-specific 90/60/120-second overrides"
)
...
EXPECTED_RELEASE_CONTRACT_MUTATIONS = {
    "stale-architecture-evidence-counts": (
        ...
        "Reproduce twelve dedicated prerequisite/member checks",
    ),
    ...
    "stale-architecture-evidence-run-counts": (
        ...
        "The release checker compares the dedicated twelve-command run body",
    ),
...
EXPECTED_RELEASE_FIXTURE_README_MUTATIONS = {
    "stale-architecture-evidence-fixture-readme-count": (
        ...
        "Twenty-nine architecture-evidence inventory mutations",
        "repository-release fixture README must carry exactly the "
        "executable-derived boundary 'Thirty-one architecture-evidence "
        "inventory mutations'",
    ),
