...
DEDICATED_ARCHITECTURE_EVIDENCE_COMMANDS = (
    ...
    (
        ...
        "python tests/profile-0-3-product-domain-frames/authoring/"
        "generate_vectors.py --check && "
        "python scripts/validate_profile_0_3_product_domain_frames.py "
        "--recompute-all "
        '--python-executable "$ODEYA_PRQ002_PYTHON" '
        '--node-executable "$ODEYA_PRQ002_NODE"',
    ),
...
EXPECTED_INTEGRATED_VALIDATOR_SHA256 = (
    "ca998e15198f5d42ee3593a95d5ac5e0c79601517ce282d1918a32a9356f7311"
)
