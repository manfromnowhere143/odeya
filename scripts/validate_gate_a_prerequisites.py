...
RECOVERY_SECTION_SHA256 = (
    "357666b2230d9ceac9ab6c3cd0db66e521be173bab6a08c5afed9b67aac33a51"
)
...
EXPECTED_RECOVERY_PROGRAM_SHA256 = (
    "d7497d18db547e9113c91b1b9523c1ace8a11bd53de6df5d21b5822d5e3949bb"
)
...
def recovery_truth_surface_known_bad_self_tests(errors: list[str]) -> int:
    ...
    invariant = (
        "A dirty next-session state, merge, extra commit, second dirty\n"
        "architecture lane, or path substitution requires a new exact "
