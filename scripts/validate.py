...
REQUIRED_FILES = (
    ...
    "architecture/prq-002-aggregate-state-member-probe.schema.json",
    "architecture/prq-002-reducer-member-probe.schema.json",
    "architecture/prq-002-event-member-probe.schema.json",
    "architecture/prq-002-ordered-member-map-commitment-probe.schema.json",
    "architecture/prq-002-pure-registry-snapshot-probe.schema.json",
    "architecture/prq-002-structural-state.schema.json",
    "architecture/prq-002-structural-event.schema.json",
    ...
    "tests/profile-0-3-product-domain-frames/README.md",
    "tests/profile-0-3-product-domain-frames/manifest.json",
    "tests/profile-0-3-product-domain-frames/vectors.json",
    "tests/profile-0-3-product-domain-frames/cases.json",
    "tests/profile-0-3-product-domain-frames/authoring/generate_vectors.py",
    "tests/profile-0-3-product-domain-frames/authoring/generate_suite_metadata.py",
    "tests/profile-0-3-product-domain-frames/authoring/retain_results.py",
    "tests/profile-0-3-product-domain-frames/python/runner.py",
    "tests/profile-0-3-product-domain-frames/python/dependency-lock.json",
    "tests/profile-0-3-product-domain-frames/python/source-manifest.json",
    "tests/profile-0-3-product-domain-frames/node/runner.mjs",
    "tests/profile-0-3-product-domain-frames/node/package.json",
    "tests/profile-0-3-product-domain-frames/node/package-lock.json",
    "tests/profile-0-3-product-domain-frames/node/source-manifest.json",
    "tests/profile-0-3-product-domain-frames/results/python-frames-result.json",
    "tests/profile-0-3-product-domain-frames/results/node-frames-result.json",
    ...
    "tests/prq-002-identity-cohort/README.md",
    "tests/prq-002-identity-cohort/check.py",
    "tests/prq-002-identity-cohort/manifest.json",
    "tests/prq-002-identity-cohort/input-manifest.json",
    "tests/prq-002-identity-cohort/cases.json",
    "tests/prq-002-identity-cohort/fixtures/candidate-cohort.probe.json",
    "tests/prq-002-identity-cohort/python/runner.py",
    "tests/prq-002-identity-cohort/python/requirements.lock",
    "tests/prq-002-identity-cohort/python/source-manifest.json",
    "tests/prq-002-identity-cohort/node/runner.mjs",
    "tests/prq-002-identity-cohort/node/package.json",
    "tests/prq-002-identity-cohort/node/package-lock.json",
    "tests/prq-002-identity-cohort/node/source-manifest.json",
    "tests/prq-002-identity-cohort/results/python-rfc8785-0.1.4.json",
    "tests/prq-002-identity-cohort/results/node-canonicalize-3.0.0.json",
    "tests/prq-002-identity-cohort/results/comparison-receipt.json",
    "tests/prq-002-identity-cohort/results/python-execution-receipt.json",
    "tests/prq-002-identity-cohort/results/node-execution-receipt.json",
    ...
    for relative in ISOLATED_CONTRACT_SUITES:
        ...
        try:
            result = subprocess.run(
                ...
                capture_output=True,
                text=True,
                timeout=ISOLATED_CONTRACT_SUITE_TIMEOUT_SECONDS.get(
